...
class PSUnresolvedReferenceInspectionTest : BasePlatformTestCase() {
    ...
    fun `test doesn't report unresolved exported value declaration when module exporting it self`() {
        myFixture.configureByText(
            "Foo.purs",
            """
            module Foo (module Foo) where
    ...
    fun `test it finds imported operator if exported with module syntax`() {
        myFixture.configureByText(
            "Lib.purs",
            """
    ...
    fun `test it finds imported operator when exporting`() {
        myFixture.configureByText(
            "Lib.purs",
            """
            module Lib where
    ...
    fun `test it finds imported operator when exporting as module`() {
        myFixture.configureByText(
            "Add.purs",
            """
            module Add where
        ...
        myFixture.configureByText(
            ...
            import Add as Export
            import Other as Export
            """.trimIndent()
        )
        myFixture.configureByText(
            "Main.purs",
