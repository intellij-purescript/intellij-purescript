...
class ConstructorFixityDeclaration : PSStubbedElement<ConstructorFixityDeclaration.Stub>,
    FixityDeclaration,
    InlinableElement,
    DocCommentOwner {
    class Stub(val name: String, p: StubElement<*>?) :
        AStub<ConstructorFixityDeclaration>(p, Type) {
    ...
    object Type : WithPsiAndStub<Stub, ConstructorFixityDeclaration>("ConstructorFixityDeclaration") {
        override fun createPsi(node: ASTNode) = ConstructorFixityDeclaration(node)
        override fun createPsi(stub: Stub) = ConstructorFixityDeclaration(stub, this)
        override fun createStub(psi: ConstructorFixityDeclaration, p: StubElement<*>?) = Stub(psi.name, p)
    ...
    override val associativity get() = fixity.associativity
    override val precedence get() = fixity.precedence
    ...
    override fun getReference() = ConstructorFixityReference(this)
}