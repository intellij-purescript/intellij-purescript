...
class TypeFixityDeclaration : PSStubbedElement<TypeFixityDeclaration.Stub>,
    ...
    class Stub(val name: String, p: StubElement<*>?) :
        AStub<TypeFixityDeclaration>(p, Type) {
    ...
    object Type : WithPsiAndStub<Stub, TypeFixityDeclaration>("TypeFixityDeclaration") {
        override fun createPsi(node: ASTNode) = TypeFixityDeclaration(node)
        override fun createPsi(stub: Stub) = TypeFixityDeclaration(stub, this)
        override fun createStub(psi: TypeFixityDeclaration, p: StubElement<*>?) = Stub(psi.name, p)
    ...
    override fun getReference() = TypeFixityReference(this)
}