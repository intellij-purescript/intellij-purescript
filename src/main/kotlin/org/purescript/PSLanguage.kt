...
object PSLanguage : Language("Purescript", "text/purescript", "text/x-purescript", "application/x-purescript") {
    ...
    fun getBuiltins(moduleName: String): List<PrimTypePsiElement> {
        val members = BUILTIN_MODULES_MAP[moduleName] ?: emptyList()
        return members.map { PrimTypePsiElement(moduleName, it) }
    }
...
class PrimTypePsiElement(val moduleName: String, private val name: String) : FakePsiElement(), Importable {
