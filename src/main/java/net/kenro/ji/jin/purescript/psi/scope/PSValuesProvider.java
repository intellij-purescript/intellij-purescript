...
//    private Stack<PSBinder> binders = new Stack<>();
...
//            ElmPsiImplUtil.getDeclarationsFromPattern(this.binders.pop())
//                    .forEach(ids::add);
//            return nextId();
//        }
//
//        if (this.elem == null || this.elem instanceof PSBinder) {
...
//                .filter(c -> c instanceof PSBinder)
//                .map(p -> (PSBinder)p)
//                .forEach(this.binders::add);
//
...
//        this.binders.addAll(elem.getPatternList());
//    }
//
...
//                        this.binders.add((ElmPattern) child);
